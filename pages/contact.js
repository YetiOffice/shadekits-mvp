      ...
      <Section title="Get a Free Quote" className="py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-2xl bg-white border border-neutral-200 p-6 shadow-sm">
            <div className="text-sm text-neutral-700">Send us your project details and we’ll reply fast.</div>
            <form className="mt-4 grid grid-cols-1 gap-3" onSubmit={(e)=>{e.preventDefault(); alert('Thanks! We\\'ll be in touch.')}}>
              ...
              <textarea className="rounded-xl border border-neutral-300 px-3 py-2" placeholder="Tell us about your site (dimensions, pad, timeline)"></textarea>
          ...
          <div className="rounded-2xl bg-white border border-neutral-200 p-6 shadow-sm">
            ...
            <div className="text-sm text-neutral-700 mt-2">Email: <a className="underline" href={`mailto:${email}`}>{email}</a></div>
            <div className="text-sm text-neutral-700">Phone: <a className="underline" href={`tel:${phone}`}>{phone}</a></div>
